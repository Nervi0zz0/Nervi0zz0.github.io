...
<!-- Sección de premios -->
<div style="background: linear-gradient(135deg, #222, #333); padding: 20px; border-radius: 15px; text-align: center; color: #FFD700; box-shadow: 0 8px 20px rgba(255, 255, 255, 0.1);">
  <h2 style="font-family: 'Arial Black', sans-serif; font-size: 28px; margin-bottom: 15px;">🏆 ¡Y el premio es para...!</h2>
  <p style="font-family: 'Helvetica', sans-serif; font-size: 18px; color: #ccc; text-align: justify; max-width: 900px; margin: 0 auto; line-height: 1.6;">
...
<div style="background: linear-gradient(135deg, #333, #444); padding: 20px; border-radius: 15px; text-align: center; color: #fff; box-shadow: 0 8px 20px rgba(255, 255, 255, 0.1);">
  <h2 style="font-family: 'Arial Black', sans-serif; font-size: 28px; margin-bottom: 15px;">🤔 ¿Ciberseguridad o una sitcom? 📺</h2>
  <p style="font-family: 'Helvetica', sans-serif; font-size: 18px; color: #ccc; text-align: justify; max-width: 800px; margin: 0 auto; line-height: 1.8;">
...
<div style="background: linear-gradient(135deg, #222, #333); padding: 20px; border-radius: 15px; text-align: center; color: #FFD700; box-shadow: 0 8px 20px rgba(255, 255, 255, 0.1);">
  <h2 style="font-family: 'Arial Black', sans-serif; font-size: 28px; margin-bottom: 15px;">💪 Lo importante... ¡El Talento! 🏅</h2>
  <p style="font-family: 'Helvetica', sans-serif; font-size: 18px; color: #ccc; text-align: justify; max-width: 800px; margin: 0 auto; line-height: 1.8;">
  ...
  <p style="font-family: 'Helvetica', sans-serif; font-size: 16px; color: #bbb; text-align: center; max-width: 700px; margin: 0 auto; line-height: 1.6;">
