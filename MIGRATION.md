...
<div style="font-size: 1rem; line-height: 1.8; color: #EEE; border-left: 5px solid #5A5A5A; padding-left: 15px; margin-bottom: 30px;">
...
<div style="font-size: 0.95rem; line-height: 1.8; color: #CCC; border-left: 5px solid #5A5A5A; padding-left: 15px; margin-bottom: 30px;">
  El networking aquí es sencillo: haces cola para que te escaneen la acreditación y te llevas un bolígrafo que no escribe y una camiseta dos tallas más grande. ¿El truco? Actuar como si realmente necesitas esos productos para sobrevivir. A estas alturas, **el merchandising es la verdadera moneda de cambio.**
</div>
...
<div class="post-footer" style="text-align: center; margin: 50px 0;">
  <img src="/assets/images/ccncert/stic2.jpg" alt="Imagen final STIC" style="width: 35%; max-width: 350px; border-radius: 20px; border: 2px solid #5A5A5A; background-color: #222; padding: 5px;">
</div>

<hr style="border: none; border-top: 1px solid #5A5A5A; margin: 50px 0;">

<div style="text-align: center; margin: 50px auto;">
  <img src="/assets/images/cojo.png" alt="Firma" style="max-width: 15%; border-radius: 50%; border: 2px solid #5A5A5A; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.5);">
</div>
